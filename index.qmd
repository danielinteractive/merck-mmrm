...
- The [`rbmi` package](https://insightsengineering.github.io/rbmi) implements these methods, and internally uses `mmrm`:
  - Bayesian inference (with Stan implementation) 
